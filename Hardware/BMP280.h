...
#define BMP280_ADDRESS											 0x76		//从设备地址,ID寄存器
#define BMP280_RESET_VALUE									 0xB6		//复位寄存器写入值，只要写入这个值就会复位

#define BMP280_CHIPID_REG                    0xD0  /*Chip ID Register *///ID寄存器，读取寄存器会获得一个值
#define BMP280_RESET_REG                     0xE0  /*Softreset Register *///重置复位
#define BMP280_STATUS_REG                    0xF3  /*Status Register *///状态寄存器
#define BMP280_CTRLMEAS_REG                  0xF4  /*Ctrl Measure Register */
#define BMP280_CONFIG_REG                    0xF5  /*Configuration Register *///配置
#define BMP280_PRESSURE_MSB_REG              0xF7  /*Pressure MSB Register *///压力
#define BMP280_PRESSURE_LSB_REG              0xF8  /*Pressure LSB Register *///压力
#define BMP280_PRESSURE_XLSB_REG             0xF9  /*Pressure XLSB Register *///压力
#define BMP280_TEMPERATURE_MSB_REG           0xFA  /*Temperature MSB Reg *///温度
#define BMP280_TEMPERATURE_LSB_REG           0xFB  /*Temperature LSB Reg *///温度
#define BMP280_TEMPERATURE_XLSB_REG          0xFC  /*Temperature XLSB Reg *///温度
//状态寄存器转换标志
