...
#define MPU6050_IIC_SCL_Pin                GPIO_Pin_1         //PB1
#define MPU6050_IIC_SDA_Pin                GPIO_Pin_0      //PB0

#define	MPU6050_IIC_SCL                    PBout(1)
#define	MPU6050_IIC_SDA                    PBout(0)  
#define	MPU6050_IIC_SDA_IN                 PBin(0)              //读数据端口
